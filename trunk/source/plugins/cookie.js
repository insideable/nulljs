nulljs.load("com.nulljs.(array|hash)").module("com.nulljs.cookie", function (api) {
	
	var A = api.com.nulljs.array, H = api.com.nulljs.hash;
	...
	var getCookies = function () {
		return document.cookie.split("; ").mapFilter(
			function (pair) {
	...
	var findCookie = function (name) {
		var a = getCookies().filter(function (cookie) { return cookie.name().toLowerCase() == name.toLowerCase(); });
	...
	var clearCookies = function () {
		getCookies().forEach(function (cookie) { deleteCookie(cookie); });
	};
